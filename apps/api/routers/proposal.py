...
async def create_proposal(
    ...
    from tasks.proposal_tasks import generate_proposal_sections_task
    background_tasks.add_task(generate_proposal_sections_task, str(proposal.id), str(rfp_id), sections_to_use)
...
async def create_direct_proposal(
    ...
    from tasks.proposal_tasks import generate_proposal_sections_task
    background_tasks.add_task(generate_proposal_sections_task, str(proposal.id), str(stub_rfp.id), sections_to_use)
